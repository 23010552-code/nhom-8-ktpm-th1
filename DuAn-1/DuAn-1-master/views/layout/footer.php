                  ...
                  <div class="col-lg-3 col-md-6">
                      <div class="widget-item">
                          ...
                          <div class="widget-body">
                              <p>Chúng tôi thiết kế và phát triển các giải pháp website chuyên nghiệp, mang đến chất lượng và hiệu quả cho mọi dự án.</p>
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6">
                      <div class="widget-item">
                          ...
                          <div class="widget-body">
                              <address class="contact-block">
                                  <ul>
                                      <li><i class="pe-7s-home"></i>Đại học Phenikaa</li>
              ...
              <div class="row align-items-center mt-20">
                  <div class="col-md-6">
                      <div class="newsletter-wrapper">
                          <h6 class="widget-title-text">Đăng ký </h6>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="copyright-text text-center">
                          <p>&copy; 2025 <b>Adidas</b> Được tạo <i class="fa fa-heart text-danger"></i> bởi <a href="http://localhost/DuAn-1/#"><b>Nhom2_adidas</b></a></p>
                      </div>
                  </div>
              </div>
          </div>
                              ...
                              <li class="minicart-item">
                                  <div class="minicart-thumb">
                                      <a href="product-details.html">
                                          <img src="<?php echo BASE_URL . $item['hinh_anh'] ?>" alt="product">
                                      </a>
                                  </div>
                                  <div class="minicart-content">
                                      <h3 class="product-name">
                                          <a href="product-details.html"><?php echo $item['ten_san_pham'] ?></a>
                                      </h3>
                                      <p>
